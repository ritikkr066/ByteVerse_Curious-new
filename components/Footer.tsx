...
const Footer1 = () => {
  ...
  <div className="container flex flex-col items-center justify-around px-5 py-1 mx-auto sm:flex-row">
    ...
    <p className="mt-1 text-sm text-gray-500 sm:ml-4 sm:pl-4 sm:border-l-2 sm:border-gray-200 sm:py-2 sm:mt-0">© 2023 personal space —
