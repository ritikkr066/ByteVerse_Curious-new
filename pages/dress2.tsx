...
<section className="text-gray-600 body-font">
  ...
  <div className='flex justify-center pb-8 -top-py-6'>
    ...
    <div className="flex flex-wrap -m-4">
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc2.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc3.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc5.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc7.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc8.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc9.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
      ...
      <div className="w-full p-4 m-1 mx-3 mx-auto my-4 shadow-2xl lg:w-1/5 md:w-1/2"><Link href={'/product/ritik'}
         className="relative block overflow-hidden rounded">
          <img alt="ecommerce" className="m-auto md:mx-0 block h-[30vh] md:h-[36vh]" src="Abc10.jpg"/>
        </Link>
        <div className="mt-4 text-center xl:text-left">
          <h3 className="mb-1 text-xs tracking-widest text-gray-500 title-font">T-Shirts</h3>
          <h2 className="text-lg font-medium text-gray-900 title-font">The Catalyzer</h2>
