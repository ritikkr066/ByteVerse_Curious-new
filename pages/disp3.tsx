...
const Disp3= () => {
  ...
  <div className="container px-5 py-24 mx-auto bg-white">
    <div className="flex flex-wrap mx-auto lg:w-4/5">
      <img alt="ecommerce" className="object-cover object-center max-w-xl rounded w-16px h-22px lg:w-1/2 lg:h-auto" src="COUPLE2.webp" />
      <div className="w-full mt-6 lg:w-1/2 lg:pl-10 lg:py-6 lg:mt-0">
        {/* <h2 className="text-sm tracking-widest text-gray-500 title-font">BIBA</h2> */}
        <h1 className="mb-1 text-3xl font-medium text-gray-900 title-font">BIBA</h1>
        ...
        <p className="leading-relaxed">BIBA, a synonym for pretty women in Punjabi, is a home-grown fashion brand, started by Mrs. Meena Bindra in 1988. Since then, it has become synonymous with ethnic wear in India. BIBA’s journey so far has been nothing but momentous and incredible, and the story behind the brand is as awe-inspiring as the woman who created it.Over the years BIBA has been the first choice of many actors like Preity Zinta, Esha Deol, Kareena Kapoor, Gauhaar Khan among others. The trendy “Mix and Match” salwaars and dupattas have not just made it to Page 3 but also to the hearts of our favourite stars because of their timeless beauty and design.</p>
        <div className="flex items-center pb-5 mt-6 mb-5 border-b-2 border-gray-100">
          ...
          <div className="flex items-center ml-6">
            ...
            <div className="relative">
              ...
              <span className='mx-4 text-black'>MALE</span>
            </div>
          </div>
        </div>
        <div className="flex items-center pb-5 mt-6 mb-5 border-b-2 border-gray-100">
          ...
          <div className="flex items-center ml-6">
            ...
            <div className="relative">
              ...
              <span className='mx-4 text-black'>FEMALE</span>
            </div>
          </div>
        </div>
        <div className="flex">
          <span className="text-2xl font-medium text-gray-900 title-font">₹399.00</span>
